...
Now includes optional Lazy Load for larger galleries that slow down page loads.
...
== Changelog ==
3.0 - Added in an option for Lazy Load. Includes option to exclude the Lazy Load library to help avoid other plugin or theme conflicts. Also, removed the has_shortcode conditional since it feels like more and more people are putting the gallery shortcode in fields generated by ACF, Meta Fields, etc. Also, started setting up the plugin for multiple language support. Still working through it, hope to have Spanish, German, French and Russian sometime in Spring of 2015.
...
== Upgrade Notice ==
3.0 - Added in an option for Lazy Load. Includes option to exclude the Lazy Load library to help avoid other plugin or theme conflicts. New captions that show on hover have been added that can also be disabled. Also, removed the has_shortcode conditional since it feels like more and more people are putting the gallery shortcode in fields generated by ACF, Meta Fields, etc. Also, started setting up the plugin for multiple language support. Still working through it, hope to have Spanish, German, French and Russian sometime in Spring of 2015.
